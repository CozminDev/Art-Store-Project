        ...
        this.data.login(this.creds)
            ...
            if (success) {
                if (_this.data.order.items.length == 0)
                    ...
                    return _this.router.navigate(["checkout"]);
            }
        }, function (err) { return _this.errorMessage = "Username or Password incorrect"; });
    };
    Login = __decorate([
        core_1.Component({
            selector: "login",
